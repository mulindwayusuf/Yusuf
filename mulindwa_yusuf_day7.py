...
with open('yusuf.txt', 'w') as file:
    file.write('I am Mulindwa Yusuf and I love Liverpool.\n')
    file .write('I use python for automation')
    
# Reading from a text file
with open('yusuf.txt', 'r') as file:
    content = file.read()
    print(content)
...
with open ('yusuf.csv', 'w', newline='') as csv_file:
    writer = csv.writer(csv_file)
    writer.writerow(['name', 'position', 'course'])
    writer.writerow(['Mulindwa Yusuf', 'Student', 'BSSE'])
    
# Read from a CSV file
with open('yusuf.csv', 'r') as csv_file:
...
student1 = ET.SubElement(root, "student", id="S176")
